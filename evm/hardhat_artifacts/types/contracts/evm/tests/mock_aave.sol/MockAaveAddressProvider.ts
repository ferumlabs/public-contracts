...
export interface MockAaveAddressProviderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getACLAdmin"
      | "getACLManager"
...
export interface MockAaveAddressProvider extends BaseContract {
  connect(runner?: ContractRunner | null): MockAaveAddressProvider;
  waitForDeployment(): Promise<this>;

  interface: MockAaveAddressProviderInterface;
  ...
  setACLAdmin: TypedContractMethod<[arg0: AddressLike], [void], "view">;

  setACLManager: TypedContractMethod<[arg0: AddressLike], [void], "view">;
  ...
  setPoolDataProvider: TypedContractMethod<[arg0: AddressLike], [void], "view">;
  ...
  setPriceOracle: TypedContractMethod<[arg0: AddressLike], [void], "view">;
